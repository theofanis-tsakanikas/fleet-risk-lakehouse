...
* **CI/CD automation** — sticky Terraform `plan` comments on pull requests, plus a manual (`workflow_dispatch`) full-`apply` deploy that injects live Terraform outputs into the Databricks Asset Bundle.
